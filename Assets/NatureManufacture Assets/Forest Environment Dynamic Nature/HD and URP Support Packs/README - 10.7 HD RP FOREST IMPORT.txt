...
BEFORE YOU START:
- you need Unity  2020.3 or higher 
- you need HD SRP pipline 10.7 if you use higher etc custom shaders could not work but seams they should. 
Thats why we provide 10.7 version which seams to work with much higher versions aswell. 
For all higher RP versions please use 10.7 HD RP support pack.
